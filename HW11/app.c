...
float b1=0.0467; //FIR filter, values from fir1 with a cutoff frequency of 5 Hz (sampling at 100 Hz)
float b2=0.4533;
float b3=0.4533;
float b4=0.0467;
// *****************************************************************************
        ...
        case APP_STATE_SCHEDULE_WRITE:
            ...
            appData.state = APP_STATE_WAIT_FOR_WRITE_COMPLETE;
             ...
             if (aa == 1) {
                ...
                writeString(10, 20, message2, ILI9341_WHITE, ILI9341_BLACK);
                ...
                writeString(10, 30, message3, ILI9341_WHITE, ILI9341_BLACK);

                sprintf(message4, "Gx %d    ", gyro_x);

                writeString(10, 40, message4, ILI9341_WHITE, ILI9341_BLACK);

                sprintf(message5, "Gy %d    ", gyro_y);

                writeString(10, 50, message5, ILI9341_WHITE, ILI9341_BLACK);
                
                //Write values for filters:

                    //MAF filter
                a_z[i]=acc_z;//buffer acceleration
                
                if (i<=4){//at beginning cant average so set to raw values 
                maf_z=a_z[i];
                }
